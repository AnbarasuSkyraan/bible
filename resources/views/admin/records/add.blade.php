            ...
            <div class="card-body">
              ...
              @endif
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-7">
                  <select class="form-select" aria-label="Default select example" placeholder="select Book" id="books" name="books">
                    </select>
                    <span class="errorbooks"></span>
                  </div>
                </div>
                <div class="row mb-3">
                  <span class="col-sm-1"></span>
                  ...
                  <div class="col-sm-7">
                  <select class="form-select" aria-label="Default select example" placeholder="select Book" id="chapter" name="chapter">
                    </select>
                    <span class="errorchapter"></span>
                  </div>
                </div>
                <div class="row mb-3">
                  <span class="col-sm-1"></span>
                ...
                <div class="row mb-3">
                  <span class="col-sm-1"></span>
                  <label for="inputText" class="col-sm-3 col-form-label">Enter Content</label>
                  <div class="col-sm-7">
